...
# Merge and create graphical object
light.ebes <- rbind(feb, sept)

graph.ebes<- ggplot()+
  geom_jitter(data = light.ebes,
              aes(x = Irradiance, y = Depth, fill = Month),
              shape = 21, size = 3, alpha = 0.4,
              show.legend = F)+
  labs(y = 'Depth (m)', x = 'Irradiance (%)')+
...
# Merge and create graphical object
light.lobos <- rbind(feb, sept)

graph.lobos<- ggplot()+
  geom_jitter(data = light.lobos,
              aes(x = Irradiance, y = Depth, fill = Month),
              shape = 21, size = 3, alpha = 0.4,
              show.legend = F)+
  labs(y = 'Depth (m)', x = 'Irradiance (%)')+
...
# Merge and create graphical object
light.ballena <- rbind(feb, sept)

graph.ballena<- ggplot()+
  geom_jitter(data = light.ballena,
              aes(x = Irradiance, y = Depth, fill = Month),
              shape = 21, size = 3, alpha = 0.4,
              show.legend = F)+
...
# Merge and create graphical object
light.gallo <- rbind(feb, sept)

graph.gallo<- ggplot()+
  geom_jitter(data = light.gallo,
              aes(x = Irradiance, y = Depth, fill = Month),
              shape = 21, size = 3, alpha = 0.4,
              show.legend = F)+
  labs(y = 'Depth (m)', x = NULL)+
...
# Merge and create graphical object
light.ship <- rbind(feb, sept)

graph.ship<- ggplot()+
  geom_jitter(data = light.ship,
              aes(x = Irradiance, y = Depth, fill = Month),
              shape = 21, size = 3, alpha = 0.4,
              show.legend = F)+
  labs(y = 'Depth (m)', x = NULL)+
